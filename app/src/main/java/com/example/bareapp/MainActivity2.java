...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.editTextPhoneNumbers = (TextView) this.findViewById(R.id.editText_infos);

        Button buttonGetPhones = (Button) this.findViewById(R.id.button_getInfo);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        //
        if (requestCode == MY_PERMISSION_REQUEST_CODE_PHONE_STATE) {// Note: If request is cancelled, the result arrays are empty.
